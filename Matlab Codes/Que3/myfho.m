function y = myfho(x)
global Vwind Vsea lamda g l rgg rsb;
...
U5 = gamma1 * cos(theta5) + 0.5 * gamma2 * cos(2 * theta5) - gamma2 * (sin(theta1) + sin(theta2) + sin(theta3) + sin(theta4)) * sin(theta5);
...
y(6) = h + l * (cos(theta1) + cos(theta2) + cos(theta3) + cos(theta4) + cos(theta5)) + fupper - A;
